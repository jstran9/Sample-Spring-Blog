...
public class BlogDAO {
	...
	public List<Blog> getBlogs() {
		...
		try {
			blogsList = jdbcTemplateObject.query(GET_BLOG_POSTS, new BlogMapper());
		}
	...
	public Blog getaBlog(int blogID) {
		...
		try {
			singlePost = jdbcTemplateObject.queryForObject(GET_BLOG_POST, new Object[]{blogID}, new BlogMapper());
		}
		catch(DataAccessException e) {
			e.printStackTrace();
		}
	...
	public int getCreatedBlogID(String author) {
		try {
			Blog singlePost = jdbcTemplateObject.queryForObject(GET_RECENT_INSERTED_POST, new Object[]{author}, new BlogMapper());
			if(singlePost != null) {
