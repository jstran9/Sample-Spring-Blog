...
<body class = "body-background">
    ...
    <div class="container">
    	<form class="form-signin" action = "<c:url value="/processRegistration"/>" method="post" data-parsley-validate>
			...
			<input type="text" id = "userName" name="userName" class="form-control" placeholder="enter user name" maxlength = "35" data-parsley-pattern="^[a-z0-9_-]{6,35}$" onfocusout = "checkForUserName()" data-parsley-required novalidate/>
			<c:if test="${error != null}">
				<div class = "form-control" id = "userNameError">${error}</div>
			</c:if>
